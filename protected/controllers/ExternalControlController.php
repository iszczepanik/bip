...
class ExternalControlController extends Controller
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['ExternalControl']))
		{
	...
	{
		$dataProvider=new CActiveDataProvider('ExternalControl');
	...
	{
		$model=new ExternalControl('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['ExternalControl']))
			$model->attributes=$_GET['ExternalControl'];
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='external-control-form')
		{
