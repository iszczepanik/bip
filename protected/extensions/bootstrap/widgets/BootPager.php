...
class BootPager extends CLinkPager
{
	...
	public function init()
	{
		if ($this->nextPageLabel === null)
			$this->nextPageLabel = Yii::t('bootstrap','Następna').' &rarr;';

		if ($this->prevPageLabel === null)
			$this->prevPageLabel = '&larr; '.Yii::t('bootstrap','Poprzednia');

		if ($this->firstPageLabel === null)
			$this->firstPageLabel = Yii::t('bootstrap','Pierwsza');

		if ($this->lastPageLabel === null)
			$this->lastPageLabel = Yii::t('bootstrap','Ostatnia');
