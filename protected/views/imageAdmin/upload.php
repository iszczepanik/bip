...
<form enctype="multipart/form-data" class="form-horizontal" id="image-form" 
	...
	<div class="alert alert-info">Plik zostanie automatycznie przeskalowany do odpowiedniej szerokości.<br />
	Obsługiwane formaty: <strong>jpg</strong>, <strong>gif</strong> i <strong>png</strong></div>
