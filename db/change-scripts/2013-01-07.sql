...
ALTER TABLE  `fil` CHANGE  `FIL_CREATE_BY`  `FIL_CREATE_BY` INT NOT NULL ,
CHANGE  `FIL_MODIFY_BY`  `FIL_MODIFY_BY` INT NULL;

ALTER TABLE  `fil` ADD INDEX (  `FIL_CREATE_BY` );
ALTER TABLE  `fil` ADD INDEX (  `FIL_MODIFY_BY` );
